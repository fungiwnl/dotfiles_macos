# Generated by Powerlevel10k configuration wizard on 2025-06-03 at 10:41 AEST.
...
# 12h time, vertical separators, blurred heads, flat tails, 1 line, compact, few icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=188
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%250F'  # light foreground
      local      clean='%255F'  # bright foreground
      local   modified='%229F'  # warm accent foreground
      local  untracked='%153F'  # cool accent foreground
      local conflicted='%203F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%244F'  # grey foreground
      local      clean='%252F'  # muted foreground
      local   modified='%252F'  # muted foreground
      local  untracked='%252F'  # muted foreground
      local conflicted='%252F'  # muted foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=24
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=130
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=24
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=160
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=255
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=250
  # Custom icon.
